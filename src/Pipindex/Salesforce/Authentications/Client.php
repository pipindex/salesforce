...
abstract class Client {
    ...
    private function assignExceptions($e)
    {
        ...
        if ($e instanceof ServerException) {
            ...
            if($e->hasResponse()){
                throw new SalesforceException(sprintf("Server Exception: Salesforce response error: %s",$e->getResponse()));
            } else {
                throw new SalesforceException(sprintf("Server Exception: Salesforce response error: %s",$e->getRequest()));
            }
        }
    }
