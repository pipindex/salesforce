<?php namespace Pipindex\Salesforce\Authentications;

use GuzzleHttp\ClientInterface;
use Pipindex\Salesforce\Authentications\Client;
...
class WebServer extends Client implements WebServerInterface
{
    ...
    public function request($url, $options)
    {
        try {
            ...
            //Try once to authenticate and request
            try {
                $this->authenticate();
                $this->requestResource($url, $options);
            }
            catch (Exception $e) {
                throw $e;
            }
